/** NOTE: `sql-formatter` version 15.4.6,
 * replace all syntax \p{Alphabetic} \b{Mark} \b{Decimal_Number}
 * to Unicode characters in order to run the script
 * on Windows with Microsoft.ClearScript old version
 */
...
var identifierPattern = ({
  ...
  const letter = "\\u0041-\\u005A\\u0061-\\u007A\\u00C0-\\u00D6\\u00D8-\\u00F6\\u00F8-\\u00FF\\u0100-\\u017F\\u0180-\\u024F\\u0370-\\u03FF\\u0400-\\u04FF\\u0531-\\u0556\\u0561-\\u0587\\u05D0-\\u05EA\\u0621-\\u064A\\u066E-\\u06D3\\u06FA-\\u06FC\\u0710-\\u072F\\u0900-\\u097F\\u0980-\\u09FF\\u0080_";
  const number = "0-9";
...
var Tokenizer = class {
  ...
  buildRulesBeforeParams(cfg) {
    ...
    return this.validRules([
      ...
      {
        type: "NUMBER" /* NUMBER */,
        regex: /(?:0x[0-9a-fA-F]+|0b[01]+|(?:-\s*)?(?:[0-9]*\.[0-9]+|[0-9]+(?:\.[0-9]*)?)(?:[eE][-+]?[0-9]+(?:\.[0-9]+)?)?)(?![\w\u0041-\u005A\u0061-\u007A\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u00FF\u0100-\u017F\u0180-\u024F\u0370-\u03FF\u0400-\u04FF\u0531-\u0556\u0561-\u0587\u05D0-\u05EA\u0621-\u064A\u066E-\u06D3\u06FA-\u06FC\u0710-\u072F\u0900-\u097F\u0980-\u09FF])/uy
      },
